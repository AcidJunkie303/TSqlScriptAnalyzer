$targetFilePath = "C:\projects\TSqlScriptAnalyzer\src\src\DatabaseAnalyzer.Contracts.DefaultImplementations\SqlParsing\TrackingSqlFragmentVisitor.generated.cs"
