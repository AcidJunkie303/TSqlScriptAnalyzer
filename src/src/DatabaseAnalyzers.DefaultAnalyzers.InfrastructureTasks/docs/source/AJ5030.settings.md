...
It contains the properties `Pattern` and `Description`. The `Pattern` is a case sensitive regular expression and the
`Description` contains the message which is reported in case of a violation. It should be a descriptive representation
