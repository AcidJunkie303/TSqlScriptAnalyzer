...
internal static class KeywordCasingProvider
{
    ...
    private static readonly Dictionary<(TSqlTokenType, KeywordNamingPolicy), string?> KeywordCasingsByTokenType = new()
    {
        ...
        { (TSqlTokenType.Identifier, KeywordNamingPolicy.LowerCase), null },
        { (TSqlTokenType.Identifier, KeywordNamingPolicy.CamelCase), null },
        { (TSqlTokenType.Identifier, KeywordNamingPolicy.PascalCase), null },
        { (TSqlTokenType.Identifier, KeywordNamingPolicy.UpperCase), null },
        ...
        { (TSqlTokenType.IdentityInsert, KeywordNamingPolicy.LowerCase), "identity_insert" },
        { (TSqlTokenType.IdentityInsert, KeywordNamingPolicy.CamelCase), "identity_Insert" },
        { (TSqlTokenType.IdentityInsert, KeywordNamingPolicy.PascalCase), "Identity_Insert" },
        { (TSqlTokenType.IdentityInsert, KeywordNamingPolicy.UpperCase), "IDENTITY_INSERT" },
        ...
        { (TSqlTokenType.Integer, KeywordNamingPolicy.LowerCase), null },
        { (TSqlTokenType.Integer, KeywordNamingPolicy.CamelCase), null },
        { (TSqlTokenType.Integer, KeywordNamingPolicy.PascalCase), null },
        { (TSqlTokenType.Integer, KeywordNamingPolicy.UpperCase), null },
        ...
        { (TSqlTokenType.Numeric, KeywordNamingPolicy.LowerCase), null },
        { (TSqlTokenType.Numeric, KeywordNamingPolicy.CamelCase), null },
        { (TSqlTokenType.Numeric, KeywordNamingPolicy.PascalCase), null },
        { (TSqlTokenType.Numeric, KeywordNamingPolicy.UpperCase), null },
